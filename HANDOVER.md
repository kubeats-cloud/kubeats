...
| **Deploy size ceiling** | ~174 KiB headroom under the 3072 KiB free-plan limit (measured, weekly-targets restore); a big feature could still need the $5/mo Workers Paid plan | `docs/PHASE-10-Production-Readiness-Audit.md`, "Known limitations" |
