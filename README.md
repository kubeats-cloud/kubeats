...
| `0006_photo_required.sql` | Rule 12 — makes the visit photo mandatory: `log_visit()` raises `FO007`, and the `visits_photo_required` CHECK refuses a direct insert. | Yes |
